...
<body>
	...
	<div class="ui grid container">
		...
		<div class="row">
			<div class="column">
		    	<h1 class="ui header">Criar uma conta</h1>
		    	<div class="ui divider"></div>
		    	
		    	<form action="do-register" method="post" class="ui large form">
					<div class="field">
	    			...
	    			<div class="field">
				    	<div class="ui corner labeled input" style="width: 30%;">
		      				<input type="text" placeholder="Sobrenome" name="lastName" value="${user.lastName}">
		      				<div class="ui corner label">
		        				<i class="asterisk icon"></i>
		      				</div>
		    			</div>
    				...
    				<div class="field">
    					<div class="ui checkbox">
      						...
      						<label>Concordo com os Termos do QBox.</label>
    					</div>
  					</div>

  					<c:if test="${!empty param.validateMessage}">
						<div class="ui message" 
							style="box-shadow: 0px 0px 0px 1px #e0b4b4 inset, 0px 0px 0px 0px rgba(0, 0, 0, 0); 
								background-color: #fff6f6; color: #9f3a38; width: 30%;">

							<c:out value="${param.validateMessage}" />
						</div>
					</c:if>

  					<div class="ui fluid teal submit button" style="width: 30%;">Criar uma conta</div>
    			</form>
